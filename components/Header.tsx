                        ...
                        <div className="rounded-lg border border-white/10 bg-white/[0.03]">
                            ...
                            {vendorsOpen && (
                                <div id="vendors-submenu" className="flex flex-col gap-1 border-t border-white/10 px-2 py-2">
                                    ...
                                    {adminUser?.role === "admin" && <Link href="/admin/vendors/bills/historical-import" className="rounded-md px-3 py-2 text-sm text-slate-200 hover:bg-white/10 hover:text-white transition" onClick={() => setOpen(false)}>Historical Bills Import</Link>}
                                    <Link href="/admin/transactions" className="rounded-md px-3 py-2 text-sm text-slate-200 hover:bg-white/10 hover:text-white transition" onClick={() => setOpen(false)}>Transactions</Link>

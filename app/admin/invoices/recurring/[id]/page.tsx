        ...
        <main className="min-h-screen bg-[#f7f9fc] px-4 py-8 text-slate-950 sm:px-8">
            <div className="mx-auto max-w-[1500px]">
                ...
                {!invoice ? <p className="rounded-lg bg-white p-6 text-slate-500 shadow-sm">Loading...</p> : <div className="space-y-5">
                    ...
                    <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm"><div className="flex items-start justify-between gap-4"><div className="flex gap-4"><span className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-blue-600 text-lg font-bold text-white">✓</span><div><h2 className="text-xl font-medium">Send</h2><p className="mt-1 text-sm"><strong>Automatic sending:</strong> Email the invoice automatically to {invoice.member_email || "the customer"} when the invoice is generated.</p></div></div><button type="button" className="rounded-full border border-blue-200 px-6 py-2 font-semibold text-blue-300">Edit</button></div></section>

    ...
    return (
        <main className="min-h-screen bg-[#f7f9fc] px-4 py-8 text-slate-950 sm:px-8">
            <div className="mx-auto max-w-4xl">
                <header className="mb-6 flex items-center justify-between gap-4"><div><h1 className="text-4xl font-bold">Invoice settings</h1><p className="mt-1 text-sm text-slate-500">Business details and branding shown on Glitz Of Diamonds invoices.</p></div><Link href="/admin/invoices" className="font-semibold text-blue-700">Back to invoices</Link></header>

...
const initialBills: EditableBill[] = screenshotData.map(([vendorName, billDate, dueDate, amount], key) => ({
    ...
    notes: vendorName === "studio 80" && amount === "0.00" ? "Screenshot shows Paid with Total $0.00; verify whether this is a zero-value entry before importing." : "",
}));
        ...
        <main className="min-h-screen bg-slate-50 px-4 py-8 text-slate-950 sm:px-8">
            <div className="mx-auto max-w-[1500px] space-y-6">
                ...
                <div className="rounded-xl border border-amber-300 bg-amber-50 p-4 text-sm text-amber-950">
                    <strong>All 71 screenshot rows are now entered for review.</strong> The overlap screenshot identifies
                    three <strong>studio 80</strong> entries on May 30, 2026: one for $163.02
                    and two marked Paid with a $0.00 total. The two zero-value records remain
                    flagged and cannot be imported until you decide how to handle them.
                    No bill or vendor is saved merely by opening or previewing this page.

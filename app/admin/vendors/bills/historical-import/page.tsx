        ...
        <main className="min-h-screen bg-slate-50 px-4 py-8 text-slate-950 sm:px-8">
            <div className="mx-auto max-w-[1500px] space-y-6">
                ...
                <div className="rounded-xl border border-amber-300 bg-amber-50 p-4 text-sm text-amber-950">
                    <strong>These two screenshots do not contain all your bills.</strong> The Bills screenshot
                    indicates 71 total records, but only 23 complete visible rows appear across the two
                    supplied images. I prefilled those 23 below, including one <strong>studio 80</strong> row
                    with an unknown positive amount: its screenshot says Paid but Total $0.00. Correct
                    that row or remove it before importing. Add the remaining screenshots/rows separately
                    instead of assuming they have been captured.

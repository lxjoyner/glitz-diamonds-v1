...
export default async function PrintableInvoicePage({ params }: { params: Promise<{ token: string }> }) {
            ...
            <div className="mx-auto max-w-4xl bg-white p-6 sm:p-10 print:max-w-none print:p-0">
                ...
                <div className="border-b border-slate-200 pb-6">
                    ...
                    <div className="mt-5">
                        ...
                        <div className="mt-5 max-w-2xl rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm leading-6 text-slate-700 print:bg-white">
                            <p>
